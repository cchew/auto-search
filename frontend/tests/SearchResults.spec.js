...
describe('SearchResults', () => {
  it('renders item names when results exist', () => {
    const w = mountResults({ results: [{ wppId: 1, itemId: 1, itemName: 'GP FTE', score: 0.92 }], status: 'done' });
  ...
  it('renders listbox role when results exist', () => {
    const w = mountResults({ results: [{ wppId: 1, itemId: 1, itemName: 'GP FTE', score: 0.9 }], status: 'done' });
